...
<html>
	...
	padding-left:10px;
		...
		?>
	<H1> <I> <B>  <center> Welcome to  <?php echo $_SESSION['user']?> </center>  </B> </I> </H1>
...
<form action="status.php" method="post">	<td align=center> <input type="submit" value="Submit"></td></form>
</tr>
</table>
